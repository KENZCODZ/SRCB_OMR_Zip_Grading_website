...
import { BookOpen, Calendar, Trash2, ChevronRight, User, Layers, Eye } from 'lucide-react';
...
export const ExamCard: React.FC<ExamCardProps> = ({
  ...
  const getExamTypeBadgeStyle = (type?: string | null) => {
    ...
    switch (normalized) {
      ...
      case 'midterm':
        return { background: 'rgba(245, 158, 11, 0.15)', color: 'var(--srcb-gold-light)', border: '1px solid rgba(245, 158, 11, 0.3)' };
      case 'pre-final':
      case 'prefinal':
  ...
  return (
    <div
      ...
      style={{
        ...
        border: isSelected ? '1px solid var(--srcb-gold-accent)' : '1px solid var(--border)',
        background: isSelected ? 'rgba(15, 23, 42, 0.95)' : 'rgba(15, 23, 42, 0.6)',
        padding: '1rem'
      }}
    >
        ...
        <div style={{ display: 'flex', gap: '12px', flex: 1 }}>
          <div
            ...
            style={{
              ...
              color: isSelected ? 'var(--srcb-gold-accent)' : 'var(--text-secondary)',
              minWidth: '40px',
              height: '40px',
              borderRadius: '10px',
              display: 'flex',
          ...
          <div style={{ flex: 1 }}>
            ...
            <h4 style={{ margin: '0 0 6px 0', fontSize: '1.02rem', fontWeight: 700, color: 'var(--text-primary)' }}>
              {name}
            </h4>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap', fontSize: '0.78rem', color: 'var(--text-muted)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginLeft: '12px' }}>
          {onInspect && (
            <button
              ...
              style={{ width: '30px', height: '30px', opacity: 0.75 }}
            >
              <Eye size={14} />
            </button>
          )}
